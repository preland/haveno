...
public class RegexValidatorFactory {
    public static RegexValidator addressRegexValidator() {
        ...
        String usernamePasswordPattern = String.format("(?:@[a-zA-Z0-9._-]+:[a-zA-Z0-9._-]+)?");
        ...
        String fqdnRegexPattern = String
                .format("(((?!-)[a-zA-Z0-9-]{1,63}(?<!-)\\.)+(?!onion)[a-zA-Z]{2,63}(?:\\:%1$s)?)", portRegexPattern);
        regexValidator.setPattern(String.format(
                "^(?:(?:(?:%1$s)|(?:%2$s)|(?:%3$s)|(?:%4$s)|(?:%5$s))%6$s,\\s*)*(?:(?:%1$s)|(?:%2$s)|(?:%3$s)|(?:%4$s)|(?:%5$s)%6$s)*$",
                onionV2RegexPattern, onionV3RegexPattern, ipv4RegexPattern, ipv6RegexPattern, fqdnRegexPattern,
                usernamePasswordPattern));
    ...
    public static RegexValidator localhostAddressRegexValidator() {
        ...
        localhostIpv6RegexPattern = String.format("(?:%1$s)|(?:\\[%1$s\\]\\:%2$s)", localhostIpv6RegexPattern,
                portRegexPattern);
        ...
        regexValidator
                .setPattern(String.format("^(?:(?:(?:%1$s)|(?:%2$s)|(?:%3$s)),\\s*)*(?:(?:%1$s)|(?:%2$s)|(?:%3$s))*$",
    ...
    public static RegexValidator localnetAddressRegexValidator() {
        ...
        String localnetIpv6RegexPattern = "(" +
                ...
                "([fF][cCdD][0-9a-fA-F]{2}:)([0-9a-fA-F]{1,4}:){0,6}:[0-9a-fA-F]{1,4}|" + // fd00::8 fd00:2:3:4:5:6::8
                                                                                          // fd00:2:3:4:5:6::8
                "([fF][cCdD][0-9a-fA-F]{2}:)([0-9a-fA-F]{1,4}:){0,5}(:[0-9a-fA-F]{1,4}){1,1}|" + // fd00::7:8
                                                                                                 // fd00:2:3:4:5::7:8
                                                                                                 // fd00:2:3:4:5::8
                "([fF][cCdD][0-9a-fA-F]{2}:)([0-9a-fA-F]{1,4}:){0,4}(:[0-9a-fA-F]{1,4}){1,2}|" + // fd00::7:8
                                                                                                 // fd00:2:3:4:5::7:8
                                                                                                 // fd00:2:3:4:5::8
                "([fF][cCdD][0-9a-fA-F]{2}:)([0-9a-fA-F]{1,4}:){0,3}(:[0-9a-fA-F]{1,4}){1,3}|" + // fd00::6:7:8
                                                                                                 // fd00:2:3:4::6:7:8
                                                                                                 // fd00:2:3:4::8
                "([fF][cCdD][0-9a-fA-F]{2}:)([0-9a-fA-F]{1,4}:){0,2}(:[0-9a-fA-F]{1,4}){1,4}|" + // fd00::5:6:7:8
                                                                                                 // fd00:2:3::5:6:7:8
                                                                                                 // fd00:2:3::8
                "([fF][cCdD][0-9a-fA-F]{2}:)([0-9a-fA-F]{1,4}:){0,1}(:[0-9a-fA-F]{1,4}){1,5}|" + // fd00::4:5:6:7:8
                                                                                                 // fd00:2::4:5:6:7:8
                                                                                                 // fd00:2::8
        ...
        String autolocalIpv6RegexPattern = "(" +
                ...
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)([0-9a-fA-F]{1,4}:){0,6}:[0-9a-fA-F]{1,4}|" + // fe80::8
                                                                                                // fe80:2:3:4:5:6::8
                                                                                                // fe80:2:3:4:5:6::8
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)([0-9a-fA-F]{1,4}:){0,5}(:[0-9a-fA-F]{1,4}){1,1}|" + // fe80::7:8
                                                                                                       // fe80:2:3:4:5::7:8
                                                                                                       // fe80:2:3:4:5::8
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)([0-9a-fA-F]{1,4}:){0,4}(:[0-9a-fA-F]{1,4}){1,2}|" + // fe80::7:8
                                                                                                       // fe80:2:3:4:5::7:8
                                                                                                       // fe80:2:3:4:5::8
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)([0-9a-fA-F]{1,4}:){0,3}(:[0-9a-fA-F]{1,4}){1,3}|" + // fe80::6:7:8
                                                                                                       // fe80:2:3:4::6:7:8
                                                                                                       // fe80:2:3:4::8
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)([0-9a-fA-F]{1,4}:){0,2}(:[0-9a-fA-F]{1,4}){1,4}|" + // fe80::5:6:7:8
                                                                                                       // fe80:2:3::5:6:7:8
                                                                                                       // fe80:2:3::8
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)([0-9a-fA-F]{1,4}:){0,1}(:[0-9a-fA-F]{1,4}){1,5}|" + // fe80::4:5:6:7:8
                                                                                                       // fe80:2::4:5:6:7:8
                                                                                                       // fe80:2::8
                "([fF][eE][8-9a-bA-B][0-9a-fA-F]:)(:[0-9a-fA-F]{1,4}){1,6}" + // fe80::3:4:5:6:7:8 fe80::3:4:5:6:7:8
                                                                              // fe80::8
                ")";

        // allow for brackets with optional port at the end
        localnetIpv6RegexPattern = String.format("(?:%1$s)|(?:\\[%1$s\\]\\:%2$s)", localnetIpv6RegexPattern,
                portRegexPattern);

        // allow for brackets with optional port at the end
        autolocalIpv6RegexPattern = String.format("(?:%1$s)|(?:\\[%1$s\\]\\:%2$s)", autolocalIpv6RegexPattern,
                portRegexPattern);

        // match *.local
        String localFqdnRegexPattern = String.format("(((?!-)[a-zA-Z0-9-]{1,63}(?<!-)\\.)+local(?:\\:%1$s)?)",
                portRegexPattern);

        regexValidator.setPattern(String.format(
                "^(?:(?:(?:%1$s)|(?:%2$s)|(?:%3$s)|(?:%4$s)|(?:%5$s)|(?:%6$s)|(?:%7$s)),\\s*)*(?:(?:%1$s)|(?:%2$s)|(?:%3$s)|(?:%4$s)|(?:%5$s)|(?:%6$s)|(?:%7$s))*$",
                localnetIpv4RegexPatternA, localnetIpv4RegexPatternB, localnetIpv4RegexPatternC,
                autolocalIpv4RegexPattern, localnetIpv6RegexPattern, autolocalIpv6RegexPattern, localFqdnRegexPattern));
        return regexValidator;
    }
}
